    ...
    public static void doRawfitness(Chromo X)
    {
        ...
        for (int i = 0; i <= 47; i++){
            ...
            if (i != 47) {
                ...
                lat1 = lat_array.get(X.chromosome.get(i));
                lon1 = long_array.get(X.chromosome.get(i));
                lat2 = lat_array.get(X.chromosome.get(i + 1));
                lon2 = long_array.get(X.chromosome.get(i + 1));
            } else {
                lat1 = lat_array.get(X.chromosome.get(i));
                lon1 = long_array.get(X.chromosome.get(i));
